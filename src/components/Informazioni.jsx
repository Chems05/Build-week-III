        ...
        <Card>
          <Card.Body>
            ...
            <Card.Text style={{ fontSize: "15px" }}>
              {showFullText ? (
                <>
                  Sono un Full Stack Developer con esperienza pluriennale nello
                  sviluppo di applicazioni web.
                  <br />
                  Ho competenze approfondite sia sul lato front-end che sul lato
                  back-end, utilizzando tecnologie moderne come React per il
                  front-end e Node.js per il back-end.
                  <br />
                  ...
                  database, usando database relazionali come MySQL e PostgreSQL.
                  <br />
                  ...
                  implementazione di API RESTful e nell integrazione di servizi
                  di terze parti.
                  <br />
                  Ho lavorato in team agili utilizzando metodologie come Scrum,
                  garantendo una comunicazione chiara e una consegna tempestiva
                  dei progetti.
                  <br />
