      ...
      <Col>
        <Card style={{ fontSize: '14px' }} className="mb-3">
          <Card.Body>
                ...
                <ListGroup.Item key={job._id}>
                  <Row>
                    ...
                    <Col xs={8}>
                      ...
                      <h6 style={{ fontSize: '14px' }} className="text-muted">{job.candidate_required_location}</h6>
                      <h6 style={{ fontSize: '14px' }} className="text-muted">{job.category}</h6>
                      <h6 style={{ fontSize: '14px' }} className="text-muted">{job.job_type}</h6>
                      <h6 style={{fontSize:'14px'}} className="text-muted">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" data-supported-dps="24x24" fill="green" width="24" height="24" focusable="false">
            ...
            <hr />
            {!showAll && (
              <Button style={{marginLeft:'35%' }}  className="mt-3 bg-transparent border-0 text-secondary " onClick={handleShowAllClick}>
                Mostra tutto →
              </Button>
            )}
          </Card.Body>
